...
class RoomsOutcomesPage extends StatefulWidget {
  const RoomsOutcomesPage({super.key, required this.totalRevenue});
  final double totalRevenue;
  @override
  State<RoomsOutcomesPage> createState() => _RoomsOutcomesPageState();
}

class _RoomsOutcomesPageState extends State<RoomsOutcomesPage> {
  int currentPage = 1;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          BlocConsumer<RoomOutcomesCubit, RoomOutcomesState>(
            ...
            builder: (context, state) {
              if (state is LoadingAddOutcomes || state is LoadingGetOutcomes) {
                return Center(
